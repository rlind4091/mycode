...
arr4d = np.random.randint(11, size=(2, 3, 4, 5)) # 4-D array containing two 2-D arrays of 3 rows, 4 cols each
...
print("First element of arr1d is:", arr1d[-1])
print("Element in position (0,0) of arr2d is:", arr2d[-1,-1])
print("Element in position (0,0,0) of arr3d is:", arr3d[-1,-1,-1])
print("Element in position (0,0,0) of arr3d is:", arr4d[-1,-1,-1, -1])
