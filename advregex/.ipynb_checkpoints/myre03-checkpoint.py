#!/usr/bin/env Python3
import re
wood = "How much wood can a woodchuck chuck if a woodchuck could chuck wood?"
search1 = re.findall(r"wo\w+", wood)
print ("Results of findall(r'wo\w+', wood):", search1)
search2 = re.findall(r"o+", wood)
print ("Results of findall(r'o+', wood):", search2)
